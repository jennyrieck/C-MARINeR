...
#' @export
#'
#' @title compute_kplus1covstatis_partial_component_scores: compute the partial component scores (per matrix) for the compromise space.
#'
...
compute_kplus1covstatis_partial_component_scores <- function(centered_normed_matrices, compromise_decomposition_results){

  ## I should set up some safetys here, but later.

  (compromise_decomposition_results$u %*% diag(1/compromise_decomposition_results$d)) ->
    projection_matrix
